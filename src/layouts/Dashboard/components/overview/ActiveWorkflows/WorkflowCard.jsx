...
const WorkflowCard = ({ id, type, description, docCount, stage, status, updatedAt }) => {
  return (
    <div className="flex flex-col gap-4 rounded-[22px] border border-[#E5E6E8] bg-white p-5 shadow-[0_2px_8px_rgba(0,0,0,0.015)] transition hover:shadow-md dark:bg-neutral-900 dark:border-neutral-800">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex flex-col gap-0.5">
          ...
          <p className="text-xs text-[#686C72] leading-relaxed mt-0.5 max-w-xs dark:text-gray-400">
            {description}
          </p>
        </div>
      ...
      {/* Attributes Row */}
      <div className="grid grid-cols-3 gap-2 mt-1 pt-3.5 border-t border-neutral-50 text-left font-semibold text-gray-500 dark:text-gray-400">
        ...
        {/* Stage */}
        <div className="flex flex-col gap-0.5 border-l border-neutral-150 pl-3.5 col-span-2 dark:border-neutral-800">
          <span className="text-[9px] font-bold uppercase tracking-[0.5px] text-gray-400 flex items-center gap-1">
            <Settings2 size={10} />
            Current Stage
          </span>
