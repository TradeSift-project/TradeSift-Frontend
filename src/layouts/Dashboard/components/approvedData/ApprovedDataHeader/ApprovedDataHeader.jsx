  ...
  return (
    <motion.div variants={fadeUp} className="flex flex-col md:flex-row md:items-center md:justify-between py-6 border-b border-gray-150">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 text-sm text-gray-500 mt-1">
            <span className="font-semibold text-gray-700">Job ID: {jobDetails.id}</span>
            <span>•</span>
      ...
      <div className="mt-4 md:mt-0 flex gap-3">
        <button className="px-6 py-2.5 text-sm font-bold text-gray-700 bg-white border border-gray-200 rounded-full hover:bg-gray-50 transition-colors shadow-sm">
          View Audit Log
        </button>
