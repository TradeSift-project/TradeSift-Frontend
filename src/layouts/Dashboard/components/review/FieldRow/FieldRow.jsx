  ...
  return (
    <div className="flex flex-col gap-2 py-3">
      ...
      <input
        ...
        className={`w-full px-3 py-2 text-sm font-medium text-gray-900 rounded-lg border focus:outline-none focus:ring-2 focus:ring-[#F87103]/20 focus:border-[#F87103] transition-colors ${inputBorder}`}
