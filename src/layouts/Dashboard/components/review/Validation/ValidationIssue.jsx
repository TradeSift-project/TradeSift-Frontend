  ...
  return (
    <div className="flex flex-col gap-1 p-3 bg-white border-b border-gray-100 last:border-b-0 hover:bg-gray-50/50 transition-colors dark:bg-neutral-900 dark:border-neutral-800">
      <div className="flex items-center gap-2">
        ...
        <span className="ml-auto text-[10px] font-bold text-gray-400 uppercase tracking-wider bg-gray-100 px-2 py-0.5 rounded-full dark:bg-neutral-800">
          {issue.type}
        </span>
      </div>
      <p className="text-xs text-gray-500 mt-1 pl-5 dark:text-gray-400">
        {issue.description}
      </p>
    </div>
  )
