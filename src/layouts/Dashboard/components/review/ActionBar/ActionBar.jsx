  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 w-full md:w-auto mb-4 md:mb-0">
        <button
          onClick={onSaveDraft}
          className="flex-1 md:flex-none flex items-center justify-center gap-1.5 px-5 py-2.5 text-xs font-bold text-gray-700 bg-white border border-gray-200 rounded-full hover:bg-gray-50 transition-colors shadow-sm uppercase tracking-wider"
        >
          <Save size={14} />
          Save Draft
        </button>
