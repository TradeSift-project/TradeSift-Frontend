const ExtractionSummary = ({ total, reviewCount, averageConfidence }) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 bg-neutral-50/50 border border-neutral-150 rounded-[20px] p-4.5 text-center sm:text-left">
      ...
      <div className="flex flex-col gap-0.5 border-t sm:border-t-0 sm:border-l border-neutral-200 pt-4 sm:pt-0 sm:pl-4.5">
