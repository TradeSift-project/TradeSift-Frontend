  ...
  return (
    <div className="flex flex-col border border-gray-200 rounded-[24px] bg-white overflow-hidden">
      <div className="flex items-center gap-3 px-6 py-4 bg-gray-50 border-b border-gray-200">
        ...
        <span className="font-bold text-gray-900 text-sm">Terminal API Configuration</span>
      </div>
      
      <div className="flex flex-col gap-4 p-6">
        <div className="flex flex-col gap-1.5">
          <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Destination Endpoint</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-2">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm font-semibold text-gray-900">JSON Payload</span>
          </div>
          <div className="flex flex-col gap-1">
            <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Mapped Records</span>
            <span className="text-sm font-semibold text-gray-900">{fieldsCount} Fields</span>
          </div>
          <div className="flex flex-col gap-1">
            <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Authentication</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Mapping Status</span>
            <div className="flex items-center gap-1.5 text-emerald-600">
